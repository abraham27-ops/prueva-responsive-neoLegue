        ...
        html += `
            <div class="nl-row-card">
                ...
                <div class="nl-row-actions d-flex gap-1">
                    <button type="button" class="editar" title="Editar" onclick="editarUsuario(${usuario.id})">
                        <i class="bi bi-pencil-square"></i>
                    </button>
                    <button type="button" class="eliminar" title="Eliminar" onclick="borrarUsuario(${usuario.id})">
